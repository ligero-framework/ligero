...
- [x] CLI de scaffolding (`ligero new`, `ligero generate controller`): **publicado en [ligero-framework/ligero-cli](https://github.com/ligero-framework/ligero-cli)** con tests y CI. Verificado end-to-end: el proyecto generado compila y su test e2e pasa contra los artefactos de mavenLocal.
